                    ...
                    , td []
                        [ table []
                            [ tr []
                                ...
                                , td []
                                    [ ul []
                                        [ li [] [ text "Import links to your articles, videos, and answers" ]
                                        , li [] [ text "Set your featured links for viewers to see" ]
                                        , li [] [ text "Subscribe to new links from your favorite thought leaders" ]
                                        ]
                                    ]
                                ]
                            ]
            ...
            Just topic ->
                table []
                    [ tr []
                        [ td []
                            [ table []
                                [ tr [ class "bio" ] [ td [] [ img [ src <| getUrl <| model.profile.imageUrl, width 100, height 100 ] [] ] ]
