...
var _user$project$Domain_Core$parseDate = function (dateText) {
	var _p0 = A2(_elm_lang$core$String$split, '-', dateText);
	if ((((_p0.ctor === '::') && (_p0._1.ctor === '::')) && (_p0._1._1.ctor === '::')) && (_p0._1._1._1.ctor === '[]')) {
		return A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					A2(_elm_lang$core$String$left, 2, _p0._1._1._0),
					A2(_elm_lang$core$Basics_ops['++'], '/', _p0._0))));
	} else {
		return dateText;
	}
};
var _user$project$Domain_Core$onKeyDown = function (tagger) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'keydown',
...
var _user$project$Domain_Core$topicsFromLinks = function (links) {
	return A2(
...
var _user$project$Domain_Core$getLinks = F2(
	function (contentType, portfolio) {
		var _p2 = contentType;
		switch (_p2.ctor) {
			case 'Answer':
				return portfolio.answers;
			case 'Article':
				return portfolio.articles;
			case 'Podcast':
				return portfolio.podcasts;
			case 'Video':
			...
			case 'All':
				return A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						portfolio.articles,
						A2(_elm_lang$core$Basics_ops['++'], portfolio.podcasts, portfolio.videos)));
			case 'Featured':
				return A2(
					_elm_lang$core$List$filter,
					function (_) {
...
var _user$project$Domain_Core$maxTopicsToShow = 8;
var _user$project$Domain_Core$topicGroups = function (someTopics) {
	return A2(
		...
		A2(
			...
			function (t) {
				return {
					name: _elm_lang$core$Tuple$first(t),
					isFeatured: true
				};
			},
			_elm_lang$core$List$reverse(
					...
					A2(
						...
						function (_p5) {
							...
							return {
								ctor: '_Tuple2',
								_0: _p6._0,
								_1: _elm_lang$core$List$length(_p6._1)
							};
						},
						_elm_lang$core$Dict$toList(
							A2(
...
var _user$project$Domain_Core$initSubscription = {ctor: '[]'};
var _user$project$Domain_Core$initTopic = {name: '', isFeatured: false};
...
var _user$project$Domain_Core$UpdateThumbnailRequest = F2(
	function (a, b) {
		return {profileId: a, imageUrl: b};
	});
var _user$project$Domain_Core$Link = F8(
	function (a, b, c, d, e, f, g, h) {
		return {id: a, profileId: b, title: c, url: d, topics: e, contentType: f, isFeatured: g, timestamp: h};
	});
...
var _user$project$Domain_Core$Source = F5(
	function (a, b, c, d, e) {
		return {id: a, profileId: b, platform: c, accessId: d, links: e};
	});
		...
		if (_p13.ctor === 'Just') {
			return _user$project$Domain_Core$Url(
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$Domain_Core$idText(_p13._0),
						A2(
							_elm_lang$core$Basics_ops['++'],
							'/provider/',
							A2(
		...
		if (_p14.ctor === 'Just') {
			return _user$project$Domain_Core$Url(
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$Domain_Core$idText(_p14._0),
						A2(
							_elm_lang$core$Basics_ops['++'],
							'/provider/',
							_user$project$Domain_Core$idText(providerId)))));
...
var _user$project$Domain_Core$ViewPortfolio = {ctor: 'ViewPortfolio'};
...
var _user$project$Services_Adapter$toProvider = function (jsonProvider) {
	...
	return {
		...
		followers: A2(
			_elm_lang$core$List$map,
			function (x) {
				return _user$project$Domain_Core$Id(x);
			},
			field.followers),
		subscriptions: A2(
			_elm_lang$core$List$map,
...
var _user$project$Services_Adapter$JsonThumbnail = F2(
	function (a, b) {
		return {imageUrl: a, platform: b};
	});
var _user$project$Services_Adapter$JsonBootstrap = F2(
	function (a, b) {
		return {providers: a, platforms: b};
	});
var _user$project$Services_Adapter$JsonLink = F8(
	function (a, b, c, d, e, f, g, h) {
		return {id: a, profileId: b, title: c, url: d, contentType: e, topics: f, isFeatured: g, timestamp: h};
	});
...
var _user$project$Services_Adapter$JsonSubscriptionActionResponse = F2(
	function (a, b) {
		return {user: a, provider: b};
	});
	...
	return _user$project$Services_Adapter$JsonProvider(
		{
			...
			subscriptions: A2(
				_elm_lang$core$List$map,
				function (s) {
					return _user$project$Domain_Core$idText(s);
				},
...
var _user$project$Tests_TestAPI$removeSource = F2(
	function (sourceId, msg) {
		return A2(
			...
			msg,
			_elm_lang$core$Basics$toString(sourceId));
	});
...
var _user$project$Tests_TestAPI$thumbnail = F3(
	function (platform, accessId, msg) {
		return A2(
			...
			{
				platform: 'youtube',
				imageUrl: _user$project$Domain_Core$urlText(_user$project$Tests_TestAPI$someImageUrl)
			});
	});
var _user$project$Tests_TestAPI$updateThumbnail = F2(
	function (request, msg) {
		return A2(
			_user$project$Services_Adapter$httpSuccess,
			msg,
...
var _user$project$Tests_TestAPI$suggestedTopics = F2(
	function (search, msg) {
		return ((!_elm_lang$core$String$isEmpty(search)) && (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$String$length(search),
			1) > 0)) ? A2(
			_user$project$Services_Adapter$httpSuccess,
			msg,
			A2(
...
var _user$project$Tests_TestAPI$jsonLink1 = A8(
...
var _user$project$Tests_TestAPI$jsonProvider1 = _user$project$Services_Adapter$JsonProvider(
	{
		...
		subscriptions: {
			ctor: '::',
			_0: _user$project$Domain_Core$idText(_user$project$Tests_TestAPI$profile2.id),
			_1: {
				ctor: '::',
				_0: _user$project$Domain_Core$idText(_user$project$Tests_TestAPI$profile3.id),
				_1: {ctor: '[]'}
			}
		},
		followers: {
			ctor: '::',
			_0: _user$project$Domain_Core$idText(_user$project$Tests_TestAPI$profile4.id),
			_1: {
				ctor: '::',
				_0: _user$project$Domain_Core$idText(_user$project$Tests_TestAPI$profile5.id),
				_1: {ctor: '[]'}
			}
		}
	});
...
var _user$project$Tests_TestAPI$follow = F2(
	function (request, msg) {
		return A2(
			_user$project$Services_Adapter$httpSuccess,
			msg,
			{user: _user$project$Tests_TestAPI$jsonProvider2, provider: _user$project$Tests_TestAPI$jsonProvider3});
	});
...
var _user$project$Tests_TestAPI$links = F2(
	function (profileId, msg) {
		return A2(_user$project$Tests_TestAPI$provider, profileId, msg);
	});
...
var _user$project$Services_Decoders$linkDecoder = A9(
...
var _user$project$Services_Decoders$bootstrapDecoder = A3(
	...
	A2(
		...
		'platforms',
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)));
var _user$project$Services_Decoders$subscriptionActionResponseDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Services_Adapter$JsonSubscriptionActionResponse,
...
var _user$project$Services_Gateway$updateThumbnail = F2(
...
var _user$project$Services_Gateway$thumbnail = F3(
	function (platform, accessId, msg) {
		var url = A2(
			_elm_lang$core$Basics_ops['++'],
...
var _user$project$Services_Gateway$providers = function (msg) {
	var url = A2(_elm_lang$core$Basics_ops['++'], _user$project$Services_Gateway$baseUrl, 'providers/wtf');
	var request = A2(
		_elm_lang$http$Http$get,
		url,
		_elm_lang$core$Json_Decode$list(_user$project$Services_Decoders$providerDecoder));
		...
		if (_p0.ctor === 'Ok') {
			var url = A2(
				...
				A2(
					...
					'removesource/',
					_elm_lang$core$Basics$toString(_p0._0)));
			var request = A2(_elm_lang$http$Http$get, url, _elm_lang$core$Json_Decode$string);
			return A2(_elm_lang$http$Http$send, msg, request);
		} else {
...
var _user$project$Services_Gateway$bootstrap = function (msg) {
	var url = A2(_elm_lang$core$Basics_ops['++'], _user$project$Services_Gateway$baseUrl, 'bootstrap/wtf');
...
var _user$project$Services_Gateway$suggestedTopics = F2(
	function (search, msg) {
		if (!(_elm_lang$core$String$isEmpty(search) && (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$String$length(search),
			1) > 0))) {
			var url = A2(
				_elm_lang$core$Basics_ops['++'],
...
var _user$project$Services_Gateway$follow = F2(
	function (followRequest, msg) {
		...
		var request = A3(_elm_lang$http$Http$post, url, body, _user$project$Services_Decoders$subscriptionActionResponseDecoder);
		return A2(_elm_lang$http$Http$send, msg, request);
	});
				...
				if (_p0._0 === '') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								currentTopic: A2(_user$project$Domain_Core$Topic, formattedInput, true)
							}),
						_1: A2(_user$project$Settings$runtime.suggestedTopics, formattedInput, _user$project$Controls_EditProfile$TopicSuggestionResponse)
					};
				}
			case 'KeyDown':
				if (_elm_lang$core$Native_Utils.eq(_p0._0, 13)) {
					var _p1 = model.topicSuggestions;
					if (_p1.ctor === '::') {
						return onAddTopic(_p1._0);
					} else {
				...
				if (_p0._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								provider: _user$project$Services_Adapter$toProvider(_p0._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
...
var _user$project$Controls_EditProfile$view = function (model) {
	...
	var provider = model.provider;
	var profile = provider.profile;
	var firstNameCompleted = !_elm_lang$core$String$isEmpty(
		_user$project$Domain_Core$nameText(profile.firstName));
	var lastNameCompleted = !_elm_lang$core$String$isEmpty(
		_user$project$Domain_Core$nameText(profile.lastName));
	var emailCompleted = !_elm_lang$core$String$isEmpty(
		_user$project$Domain_Core$emailText(profile.email));
	var canSave = firstNameCompleted && (lastNameCompleted && emailCompleted);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$disabled(!canSave),
													_1: {ctor: '[]'}
												}
											}
										},
...
var _user$project$Controls_NewLinks$update = F2(
	function (msg, model) {
						...
						current: _elm_lang$core$Native_Utils.update(
							linkToCreate,
							{
								...
								base: _elm_lang$core$Native_Utils.update(
									linkToCreateBase,
									{
										topics: {ctor: '::', _0: topic, _1: linkToCreateBase.topics}
									})
							})
					}),
				_1: _elm_lang$core$Platform_Cmd$none
		...
		switch (_p0.ctor) {
			...
			case 'InputUrl':
				var _p1 = _p0._0;
				var link = model.current.base;
				var hasText = function (domainName) {
					return A2(
						_elm_lang$core$String$contains,
						domainName,
						_elm_lang$core$String$toLower(_p1)) ? true : false;
				};
							...
							current: _elm_lang$core$Native_Utils.update(
								linkToCreate,
								{
									base: _elm_lang$core$Native_Utils.update(
										linkToCreateBase,
										{
											url: _user$project$Domain_Core$Url(_p1),
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								current: _elm_lang$core$Native_Utils.update(
									linkToCreate,
									{
										currentTopic: A2(_user$project$Domain_Core$Topic, _p2, false)
									})
							}),
						_1: A2(_user$project$Settings$runtime.suggestedTopics, _p2, _user$project$Controls_NewLinks$TopicSuggestionResponse)
					};
				}
			case 'KeyDown':
				if (_elm_lang$core$Native_Utils.eq(_p0._0, 13)) {
					var _p3 = model.current.topicSuggestions;
					if (_p3.ctor === '::') {
						return onAddTopic(_p3._0);
					} else {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				} else {
			...
			case 'AddLink':
				var _p5 = _p0._0;
				var _p4 = {ctor: '_Tuple2', _0: _p5.current.base, _1: _p5.current};
				var link = _p4._0;
				var current = _p4._1;
...
var _user$project$Controls_NewLinks$KeyDown = function (a) {
	return {ctor: 'KeyDown', _0: a};
};
...
var _user$project$Controls_NewLinks$view = function (model) {
	...
	var base = _p6._1;
	var _p7 = function () {
		var _p8 = base.contentType;
		switch (_p8.ctor) {
			case 'Video':
				return {ctor: '_Tuple4', _0: false, _1: true, _2: false, _3: false};
			case 'Article':
				return {ctor: '_Tuple4', _0: true, _1: false, _2: false, _3: false};
			case 'Answer':
				return {ctor: '_Tuple4', _0: false, _1: false, _2: true, _3: false};
			case 'Podcast':
				return {ctor: '_Tuple4', _0: false, _1: false, _2: true, _3: true};
			case 'Unknown':
				return {ctor: '_Tuple4', _0: false, _1: false, _2: false, _3: false};
			case 'All':
				return {ctor: '_Tuple4', _0: false, _1: false, _2: false, _3: false};
			default:
				return {ctor: '_Tuple4', _0: false, _1: false, _2: false, _3: false};
	...
	var isArticle = _p7._0;
	var isVideo = _p7._1;
	var isAnswer = _p7._2;
	var isPodcast = _p7._3;
	var listview = A2(
																									...
																									_elm_lang$html$Html$input,
																									{
																										...
																										_1: {
																											...
																											_1: {
																												...
																												_1: {
																													ctor: '::',
																													_0: _user$project$Domain_Core$onKeyDown(_user$project$Controls_NewLinks$KeyDown),
																													_1: {
																														ctor: '::',
...
var _user$project$Controls_Portfolio$linksUI = function (links) {
	return A2(
		_elm_lang$core$List$map,
		_user$project$Controls_Portfolio$decorateIfFeatured,
		A2(
			_elm_lang$core$List$take,
			5,
...
var _user$project$Controls_Portfolio$onTopicSelected = F2(
...
var _user$project$Controls_Portfolio$TopicSelected = function (a) {
	return {ctor: 'TopicSelected', _0: a};
};
var _user$project$Controls_Portfolio$TopicSuggestionResponse = function (a) {
	return {ctor: 'TopicSuggestionResponse', _0: a};
};
var _user$project$Controls_Portfolio$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			...
			case 'KeyDown':
				if (_elm_lang$core$Native_Utils.eq(_p1._0, 13)) {
					var _p3 = model.topicSuggestions;
					if (_p3.ctor === '::') {
						var _p4 = _p3._0;
						return A2(_user$project$Domain_Core$hasMatch, _p4, model.provider.filteredPortfolio.topics) ? A2(_user$project$Controls_Portfolio$onTopicSelected, model, _p4) : {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					} else {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				} else {
			...
			default:
				return A2(_user$project$Controls_Portfolio$onTopicSelected, model, _p1._0);
		}
	});
var _user$project$Controls_Portfolio$KeyDown = function (a) {
	return {ctor: 'KeyDown', _0: a};
};
var _user$project$Controls_Portfolio$Input = function (a) {
...
var _user$project$Controls_Portfolio$view = F2(
	function (linksFrom, model) {
					...
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$Controls_Portfolio$TopicSelected(topic)),
								_1: {ctor: '[]'}
							}
						},
						{
		...
		var answerCount = _p5._0;
		var articleCount = _p5._1;
		var podcastCount = _p5._2;
		var videoCount = _p5._3;
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
																				...
																				_0: A2(
																					_elm_lang$html$Html$input,
																					{
																						...
																						_1: {
																							...
																							_1: {
																								ctor: '::',
																								_0: _user$project$Domain_Core$onKeyDown(_user$project$Controls_Portfolio$KeyDown),
																								_1: {
																									ctor: '::',
...
var _user$project$Controls_ProfileThumbnail$update = F2(
	function (msg, provider) {
		...
		if (_p4.ctor === 'SubscribeResponse') {
			var _p5 = _p4._0;
			if (_p5.ctor === 'Ok') {
				var updatedProvider = _p5._0.provider;
				return {
					ctor: '_Tuple2',
					_0: _user$project$Services_Adapter$toProvider(updatedProvider),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			} else {
			...
			if (_p6.ctor === 'Subscribe') {
				...
				return {
					...
					_1: A2(
						...
						{subscriberId: _p6._0.profile.id, providerId: _p7.profile.id},
				...
				return {
					...
					_1: A2(
						...
						{subscriberId: _p6._0.profile.id, providerId: _p8.profile.id},
						_user$project$Controls_ProfileThumbnail$SubscribeResponse)
				};
			}
		}
...
var _user$project$Controls_ProfileThumbnail$thumbnail = F3(
	function (loggedIn, showSubscriptionState, provider) {
		var parseDate = function (dateText) {
			var _p9 = A2(_elm_lang$core$String$split, '-', dateText);
			if ((((_p9.ctor === '::') && (_p9._1.ctor === '::')) && (_p9._1._1.ctor === '::')) && (_p9._1._1._1.ctor === '[]')) {
				return A2(
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							A2(_elm_lang$core$String$left, 2, _p9._1._1._0),
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('postDate'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(
												parseDate(l.timestamp)),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
		...
		if (_p10.ctor === 'Just') {
			...
			var alreadySubscribed = A2(
				...
				function (subscription) {
					return _elm_lang$core$Native_Utils.eq(subscription, provider.profile.id);
				},
				_p11.subscriptions);
			var placeholder = ((!alreadySubscribed) && showSubscriptionState) ? A2(
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Controls_ProfileThumbnail$UpdateSubscription(
								A2(_user$project$Domain_Core$Subscribe, _p11, provider))),
						_1: {ctor: '[]'}
					}
				},
				{
				...
				_elm_lang$html$Html$button,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Controls_ProfileThumbnail$UpdateSubscription(
								A2(_user$project$Domain_Core$Unsubscribe, _p11, provider))),
						_1: {ctor: '[]'}
					}
				},
				{
														...
														},
														{
															...
															_0: _elm_lang$html$Html$text(
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	_elm_lang$core$Basics$toString(
																		_elm_lang$core$List$length(provider.followers)),
																	' subscribers')),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												_elm_lang$html$Html$a,
												{
													...
													_0: _elm_lang$html$Html_Attributes$href(
														_user$project$Domain_Core$urlText(
															A2(_user$project$Domain_Core$providerUrl, _elm_lang$core$Maybe$Nothing, provider.profile.id))),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
...
var _user$project$Controls_ProviderContentTypeLinks$view = F3(
	function (provider, contentType, isOwner) {
		...
		var posts = A2(_user$project$Domain_Core$getLinks, contentType, links);
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('xx'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						_user$project$Domain_Core$parseDate(link.timestamp)),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Controls_Sources$Model = F4(
	function (a, b, c, d) {
		return {profileId: a, platforms: b, source: c, sources: d};
	});
...
var _user$project$Controls_Sources$sourceUI = function (source) {
	var accessId = (_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$String$length(source.accessId),
		28) > 0) ? A2(
		_elm_lang$core$Basics_ops['++'],
		A2(_elm_lang$core$String$left, 28, source.accessId),
		'...') : source.accessId;
	return A2(
		_elm_lang$html$Html$tr,
		{
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(accessId),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
...
var _user$project$Controls_Sources$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'AddResponse':
				if (_p0._0.ctor === 'Ok') {
					var source = _user$project$Services_Adapter$toSource(_p0._0._0);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								sources: {ctor: '::', _0: source, _1: model.sources},
...
var _user$project$Controls_Sources$InputAccessId = function (a) {
	return {ctor: 'InputAccessId', _0: a};
};
var _user$project$Controls_Sources$view = function (model) {
	var placeholderText = function () {
		...
		switch (_p1) {
			...
			case 'RSS Feed':
				return 'i.e. http://xyz.com/feed/123';
			default:
				return 'username';
		}
	}();
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							},
							{
								ctor: '::',
								_0: instruction,
								_1: A2(_elm_lang$core$List$map, platformOption, model.platforms)
							}),
						_1: {ctor: '[]'}
					}),
				_1: {
								...
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_user$project$Controls_Sources$InputAccessId),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$value(model.source.accessId),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _user$project$Main$tryGetSession = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$core$Maybe$Nothing;
};
var _user$project$Main$tokenizeUrl = function (urlHash) {
	return A2(
		_elm_lang$core$List$drop,
		1,
		A2(_elm_lang$core$String$split, '/', urlHash));
};
var _user$project$Main$linksUI = function (links) {
	return A2(
		_elm_lang$core$List$map,
		function (link) {
...
var _user$project$Main$contentWithTopicUI = F5(
	function (linksFrom, profileId, contentType, topic, links) {
		return A2(
			_elm_lang$core$List$append,
			_user$project$Main$linksUI(links),
			{
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$a,
...
var _user$project$Main$pageNotFound = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
...
var _user$project$Main$removeProvider = F2(
...
var _user$project$Main$recentLinks = function (providers) {
...
var _user$project$Main$providerTopicPage = F2(
	function (linksfrom, model) {
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{ctor: '[]'},
												A5(
													_user$project$Main$contentWithTopicUI,
													linksfrom,
													profileId,
													_user$project$Domain_Core$Answer,
													topic,
		...
		var _p2 = _elm_lang$core$List$head(model.topics);
		if (_p2.ctor === 'Just') {
			return A2(
				_elm_lang$html$Html$table,
				{ctor: '[]'},
															...
															_0: A2(
																_elm_lang$html$Html$img,
																{
																	...
																	_1: {
																		...
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$width(55),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$height(55),
																				_1: {ctor: '[]'}
																			}
																		}
																	}
...
var _user$project$Main$footerContent = A2(
...
var _user$project$Main$renderProfileBase = F2(
...
var _user$project$Main$filterProviders = F2(
...
var _user$project$Main$matchProviders = F2(
	function (matchValue, providers) {
		return A2(_user$project$Main$filterProviders, matchValue, providers);
	});
var _user$project$Main$updatePortfolio = F2(
	function (portfolio, addedLinks) {
		var answers = A2(
			_elm_lang$core$List$append,
			portfolio.answers,
			A2(
		...
		var articles = A2(
			...
			A2(
				...
				addedLinks));
		return {topics: portfolio.topics, articles: articles, videos: videos, podcasts: podcasts, answers: answers};
	});
var _user$project$Main$onRemove = F2(
	function (model, sources) {
		var provider = model.portal.provider;
		var _p3 = {ctor: '_Tuple2', _0: provider.profile, _1: model.portal};
		var profile = _p3._0;
		var pendingPortal = _p3._1;
		var sourcesLeft = A2(
			_elm_lang$core$List$filter,
			function (c) {
		...
		var updatedProfile = _elm_lang$core$Native_Utils.update(
			profile,
			{sources: sourcesLeft});
		var pendingProvider = _elm_lang$core$Native_Utils.update(
			provider,
			{profile: updatedProfile});
		var portal = _elm_lang$core$Native_Utils.update(
			pendingPortal,
			{provider: pendingProvider, newSource: _user$project$Domain_Core$initSource});
					...
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {currentRoute: a, login: b, registration: c, platforms: d, portal: e, providers: f, scopedProviders: g, searchResult: h, selectedProvider: i, portfolioSearch: j};
									};
								};
							};
						};
...
var _user$project$Main$NavigateBack = {ctor: 'NavigateBack'};
var _user$project$Main$Subscription = function (a) {
	return {ctor: 'Subscription', _0: a};
};
var _user$project$Main$OnRegistration = function (a) {
	return {ctor: 'OnRegistration', _0: a};
};
var _user$project$Main$onRegistration = F2(
	function (subMsg, model) {
		var _p4 = A2(_user$project$Controls_Register$update, subMsg, model.registration);
		var form = _p4._0;
		var subCmd = _p4._1;
		var registrationCmd = A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$OnRegistration, subCmd);
		var _p5 = subMsg;
		switch (_p5.ctor) {
			case 'FirstNameInput':
				return {
			...
			default:
				var _p6 = _p5._0;
				if (_p6.ctor === 'Ok') {
					var newUser = _user$project$Services_Adapter$jsonProfileToProvider(_p6._0);
					var newState = _elm_lang$core$Native_Utils.update(
						model,
						{
							registration: form,
							portal: _elm_lang$core$Native_Utils.update(
								...
								{provider: newUser, requested: _user$project$Domain_Core$EditProfile, portfolioNavigation: false, sourcesNavigation: false})
						});
					return {
						ctor: '_Tuple2',
						_0: newState,
...
var _user$project$Main$FeatureLinkResponse = function (a) {
	return {ctor: 'FeatureLinkResponse', _0: a};
};
var _user$project$Main$onUpdateProviderContentTypeLinks = F3(
	function (subMsg, model, linksfrom) {
		var provider = function () {
			var _p7 = linksfrom;
			if (_p7.ctor === 'FromPortal') {
				return A2(_user$project$Controls_ProviderContentTypeLinks$update, subMsg, model.portal.provider);
			} else {
				return A2(_user$project$Controls_ProviderContentTypeLinks$update, subMsg, model.selectedProvider);
			}
		}();
		...
		var updatedLink = _elm_lang$core$Native_Utils.update(
			_p10,
			{isFeatured: _p9});
		var filteredLinks = A3(
			_elm_community$list_extra$List_Extra$replaceIf,
			function (l) {
				return _elm_lang$core$Native_Utils.eq(l.title, _p10.title);
			},
			updatedLink,
			A2(_user$project$Domain_Core$getLinks, _user$project$Domain_Core$All, filteredPortfolio));
		...
		return {
			...
			_1: A2(
				...
				{linkId: _p10.id, isFeatured: _p9},
				_user$project$Main$FeatureLinkResponse)
		};
	});
var _user$project$Main$NavigateToProviderTopicResponse = function (a) {
	return {ctor: 'NavigateToProviderTopicResponse', _0: a};
};
var _user$project$Main$NavigateToProviderResponse = function (a) {
	return {ctor: 'NavigateToProviderResponse', _0: a};
};
var _user$project$Main$NavigateToProviderMemberTopicResponse = function (a) {
	return {ctor: 'NavigateToProviderMemberTopicResponse', _0: a};
};
var _user$project$Main$NavigateToPortalProviderMemberResponse = function (a) {
	return {ctor: 'NavigateToPortalProviderMemberResponse', _0: a};
};
var _user$project$Main$NavigateToPortalProviderTopicResponse = function (a) {
	return {ctor: 'NavigateToPortalProviderTopicResponse', _0: a};
};
var _user$project$Main$BootstrapResponse = function (a) {
...
var _user$project$Main$init = function (location) {
	return {
		...
		_1: _user$project$Settings$runtime.bootstrap(_user$project$Main$BootstrapResponse)
	};
};
var _user$project$Main$FollowersResponse = function (a) {
	return {ctor: 'FollowersResponse', _0: a};
};
var _user$project$Main$SubscriptionsResponse = function (a) {
	return {ctor: 'SubscriptionsResponse', _0: a};
};
var _user$project$Main$ProvidersResponse = function (a) {
	return {ctor: 'ProvidersResponse', _0: a};
};
var _user$project$Main$SaveThumbnailResponse = function (a) {
	return {ctor: 'SaveThumbnailResponse', _0: a};
};
var _user$project$Main$ThumbnailResponse = function (a) {
	return {ctor: 'ThumbnailResponse', _0: a};
};
var _user$project$Main$ViewLinksResponse = function (a) {
	return {ctor: 'ViewLinksResponse', _0: a};
};
var _user$project$Main$navigate = F3(
	function (msg, model, location) {
		var _p11 = _user$project$Main$tokenizeUrl(location.hash);
		_v6_8:
		do {
						...
						case 'provider':
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									...
									{currentRoute: location}),
								_1: A2(
									_user$project$Settings$runtime.links,
									_user$project$Domain_Core$Id(_p11._1._0),
									_user$project$Main$ViewLinksResponse)
							};
						case 'portal':
							...
							var updatedProfile = _elm_lang$core$Native_Utils.update(
								profile,
								{
									id: _user$project$Domain_Core$Id(_p11._1._0)
								});
							...
							return {
								ctor: '_Tuple2',
								_0: updatedModel,
								_1: A2(_user$project$Settings$runtime.recentLinkProviders, updatedProfile.id, _user$project$Main$SubscriptionsResponse)
							};
						default:
							break _v6_8;
					}
					...
					if (_p11._1._1._1.ctor === '[]') {
						switch (_p11._0) {
							case 'provider':
								var _p12 = {
									ctor: '_Tuple2',
									_0: _user$project$Domain_Core$Id(_p11._1._0),
									_1: A2(_user$project$Domain_Core$Topic, _p11._1._1._0, false)
								};
								...
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{currentRoute: location}),
									_1: A2(_user$project$Settings$runtime.links, providerId, _user$project$Main$NavigateToProviderTopicResponse)
								};
							case 'portal':
								var _p13 = {
									ctor: '_Tuple2',
								...
								var providerId = _p13._0;
								var providerTopic = _p13._1;
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{currentRoute: location}),
									_1: A2(_user$project$Settings$runtime.provider, providerId, _user$project$Main$NavigateToPortalProviderTopicResponse)
								};
							default:
								break _v6_8;
						}
					} else {
						if (_p11._1._1._1._1.ctor === '::') {
							if (((_p11._0 === 'portal') && (_p11._1._1._0 === 'provider')) && (_p11._1._1._1._1._1.ctor === '[]')) {
								var _p14 = {
									ctor: '_Tuple2',
									_0: _user$project$Domain_Core$Id(_p11._1._1._1._0),
									_1: A2(_user$project$Domain_Core$Topic, _p11._1._1._1._1._0, false)
								};
								...
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{currentRoute: location}),
									_1: A2(_user$project$Settings$runtime.links, providerId, _user$project$Main$NavigateToProviderMemberTopicResponse)
								};
							} else {
								break _v6_8;
							}
										...
										case 'provider':
											return {
												...
												_1: A2(
													...
													_user$project$Domain_Core$Id(_p11._1._1._1._0),
													_user$project$Main$NavigateToPortalProviderMemberResponse)
											};
										default:
											break _v6_8;
									}
...
var _user$project$Main$ProviderTopicContentTypeLinksAction = function (a) {
	return {ctor: 'ProviderTopicContentTypeLinksAction', _0: a};
};
var _user$project$Main$ProviderContentTypeLinksAction = function (a) {
	return {ctor: 'ProviderContentTypeLinksAction', _0: a};
};
var _user$project$Main$EditProfileAction = function (a) {
	return {ctor: 'EditProfileAction', _0: a};
};
var _user$project$Main$onEditProfile = F2(
	function (subMsg, model) {
		var _p15 = {ctor: '_Tuple2', _0: model.portal, _1: model.portal.provider};
		var portal = _p15._0;
		var provider = _p15._1;
		var _p16 = A2(_user$project$Controls_EditProfile$update, subMsg, portal.profileEditor);
		var updatedEditor = _p16._0;
		var subCmd = _p16._1;
		var editCmd = A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$EditProfileAction, subCmd);
		var newState = _elm_lang$core$Native_Utils.update(
			model,
			{
				portal: _elm_lang$core$Native_Utils.update(
					...
					var updatedModel = _elm_lang$core$Native_Utils.update(
						newState,
						{
							portal: _elm_lang$core$Native_Utils.update(
								portal,
								{
									provider: _user$project$Services_Adapter$toProvider(_p18._0),
									sourcesNavigation: true,
									portfolioNavigation: _user$project$Domain_Core$portfolioExists(provider.portfolio),
...
var _user$project$Main$PortfolioAction = function (a) {
	return {ctor: 'PortfolioAction', _0: a};
};
var _user$project$Main$onPortfolioAction = F3(
	function (subMsg, model, linksfrom) {
		var portfolioSearch = model.portfolioSearch;
		var _p19 = A2(_user$project$Controls_Portfolio$update, subMsg, portfolioSearch);
		var updatedPortfolioSearch = _p19._0;
		var subCmd = _p19._1;
		var portfolioCmd = A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$PortfolioAction, subCmd);
		var provider = function () {
			var _p20 = linksfrom;
			if (_p20.ctor === 'FromPortal') {
				return model.portal.provider;
			} else {
				return model.selectedProvider;
			}
		}();
		var search = _elm_lang$core$Native_Utils.update(
			portfolioSearch,
			{provider: provider});
		var filtered = {
			answers: A2(
		...
		var updatedPortal = _elm_lang$core$Native_Utils.update(
			portal,
			{provider: updatedPortfolioSearch.provider});
		var _p21 = subMsg;
		switch (_p21.ctor) {
			case 'TopicSelected':
				return {
				...
				if (_p22.ctor === 'FromPortal') {
					return _elm_lang$core$String$isEmpty(_p23) ? {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								...
								portfolioSearch: _elm_lang$core$Native_Utils.update(
					...
					return _elm_lang$core$String$isEmpty(_p23) ? {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								selectedProvider: _elm_lang$core$Native_Utils.update(
									provider,
									{filteredPortfolio: filtered}),
								portfolioSearch: _elm_lang$core$Native_Utils.update(
									updatedPortfolioSearch,
			...
			case 'KeyDown':
				...
				if (_p24.ctor === 'FromPortal') {
					return (_elm_lang$core$List$isEmpty(model.portfolioSearch.topicSuggestions) && _elm_lang$core$Native_Utils.eq(model.portfolioSearch.selectedTopic, _user$project$Domain_Core$initTopic)) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
					...
					return (_elm_lang$core$List$isEmpty(model.portfolioSearch.topicSuggestions) && _elm_lang$core$Native_Utils.eq(model.portfolioSearch.selectedTopic, _user$project$Domain_Core$initTopic)) ? {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{selectedProvider: updatedPortfolioSearch.provider, portfolioSearch: updatedPortfolioSearch}),
						_1: portfolioCmd
					};
				}
			default:
...
var _user$project$Main$NewLink = function (a) {
	return {ctor: 'NewLink', _0: a};
};
var _user$project$Main$onNewLink = F2(
	function (subMsg, model) {
		var _p25 = {ctor: '_Tuple2', _0: model.portal, _1: model.portal.provider};
		var pendingPortal = _p25._0;
		var provider = _p25._1;
		...
		var newLinks = _p26._0;
		var subCmd = _p26._1;
		var newLinkCmd = A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$NewLink, subCmd);
		var portal = _elm_lang$core$Native_Utils.update(
			pendingPortal,
			{newLinks: newLinks});
		var _p27 = subMsg;
		switch (_p27.ctor) {
			...
			default:
				...
				if (_p28.ctor === 'Ok') {
					...
					var updateFilter = F2(
						function (contentType, contentTypeLinks) {
							...
							var updatedContentTypeLinks = {
								ctor: '::',
								_0: _user$project$Services_Adapter$toLink(_p32),
								_1: contentTypeLinks
							};
							var _p29 = contentType;
							switch (_p29.ctor) {
								case 'Article':
									return _elm_lang$core$Native_Utils.update(
										filteredPortfolio,
					...
					var _p30 = {ctor: '_Tuple4', _0: provider.filteredPortfolio.articles, _1: provider.filteredPortfolio.answers, _2: provider.filteredPortfolio.videos, _3: provider.filteredPortfolio.podcasts};
					var articles = _p30._0;
					var answers = _p30._1;
					var videos = _p30._2;
					var podcasts = _p30._3;
					var newFilteredPortfolio = function () {
						var contentType = _user$project$Domain_Core$toContentType(_p32.contentType);
						var _p31 = contentType;
						switch (_p31.ctor) {
							case 'Article':
								return A2(updateFilter, contentType, articles);
							case 'Video':
								return A2(updateFilter, contentType, videos);
							case 'Answer':
								return A2(updateFilter, contentType, answers);
							case 'Podcast':
								return A2(updateFilter, contentType, podcasts);
							case 'All':
								return provider.filteredPortfolio;
							case 'Featured':
								return provider.filteredPortfolio;
					...
					var updatedPortal = _elm_lang$core$Native_Utils.update(
						portal,
						{
							...
							provider: _elm_lang$core$Native_Utils.update(
								provider,
								{
									portfolio: A2(_user$project$Main$updatePortfolio, provider.portfolio, newLinks.added),
					...
					return A2(
						_elm_lang$core$Native_Utils.crash(
							'Main',
							{
								start: {line: 1148, column: 25},
								end: {line: 1148, column: 36}
							}),
...
var _user$project$Main$SourcesUpdated = function (a) {
	return {ctor: 'SourcesUpdated', _0: a};
};
var _user$project$Main$onSourcesUpdated = F2(
	function (subMsg, model) {
		...
		var sources = _p33._0;
		var subCmd = _p33._1;
		var sourceCmd = A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$SourcesUpdated, subCmd);
		var pendingProvider = _elm_lang$core$Native_Utils.update(
			provider,
			{
				profile: _elm_lang$core$Native_Utils.update(
		...
		var portal = _elm_lang$core$Native_Utils.update(
			pendingPortal,
			{newSource: sources.source, provider: pendingProvider});
		var _p34 = subMsg;
		switch (_p34.ctor) {
			case 'InputAccessId':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							portal: _elm_lang$core$Native_Utils.update(
								portal,
								{
									portfolioNavigation: _user$project$Domain_Core$portfolioExists(portal.provider.portfolio),
			...
			case 'AddResponse':
				...
				if (_p35.ctor === 'Ok') {
					var _p36 = _p35._0;
					var source = _user$project$Services_Adapter$toSource(_p36);
					var portfolio = A2(_user$project$Main$updatePortfolio, provider.portfolio, source.links);
					var updatedProvider = _elm_lang$core$Native_Utils.update(
						pendingProvider,
						{portfolio: portfolio, filteredPortfolio: portfolio});
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								portal: _elm_lang$core$Native_Utils.update(
									...
									{
										provider: updatedProvider,
										portfolioNavigation: _user$project$Domain_Core$portfolioExists(portfolio),
										addLinkNavigation: true
									})
							}),
						_1: A3(
							_user$project$Settings$runtime.thumbnail,
							_user$project$Domain_Core$Platform(_p36.platform),
							_p36.accessId,
							_user$project$Main$ThumbnailResponse)
					};
				} else {
					return A2(
						_elm_lang$core$Native_Utils.crash(
							'Main',
							{
								start: {line: 1229, column: 25},
								end: {line: 1229, column: 36}
							}),
				...
				if (_p37.ctor === 'Ok') {
					...
					var updatedSources = A2(
						...
						function (s) {
							return !_elm_lang$core$Native_Utils.eq(
								s.id,
								_user$project$Domain_Core$Id(_p37._0));
						},
					...
					return A2(
						_elm_lang$core$Native_Utils.crash(
							'Main',
							{
								start: {line: 1249, column: 25},
								end: {line: 1249, column: 36}
							}),
...
var _user$project$Main$RecentProviderLinks = function (a) {
	return {ctor: 'RecentProviderLinks', _0: a};
};
var _user$project$Main$recentProvidersUI = F2(
	function (clientId, providers) {
		return A2(
			_elm_lang$html$Html$map,
			_user$project$Main$RecentProviderLinks,
			A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
...
var _user$project$Main$recentLinksContent = F2(
	function (profileId, providers) {
		return A2(
			_user$project$Main$recentProvidersUI,
			profileId,
			A2(
				_elm_lang$core$List$filter,
				function (p) {
					return (!_elm_lang$core$Native_Utils.eq(
						p.recentLinks,
						{ctor: '[]'})) && (!_elm_lang$core$Native_Utils.eq(p.profile.id, profileId));
				},
				providers));
	});
var _user$project$Main$ProfileThumbnail = function (a) {
	return {ctor: 'ProfileThumbnail', _0: a};
};
var _user$project$Main$providersUI = F3(
	function (loggedIn, showSubscriptionState, providers) {
		return A2(
			_elm_lang$html$Html$map,
			_user$project$Main$ProfileThumbnail,
			A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				A2(
...
var _user$project$Main$searchProvidersUI = F4(
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: A3(_user$project$Main$providersUI, loggedIn, showSubscriptionState, providers),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
...
var _user$project$Main$filteredProvidersUI = F3(
	function (loggedIn, placeHolder, providers) {
		return A4(
			_user$project$Main$searchProvidersUI,
			_elm_lang$core$Maybe$Just(loggedIn),
			true,
			placeHolder,
			A2(_user$project$Main$removeProvider, loggedIn.profile.id, providers));
	});
var _user$project$Main$content = F2(
	function (contentToEmbed, model) {
		var portal = model.portal;
		var loggedIn = portal.provider;
		var followingYou = portal.provider.followers;
		var following = portal.provider.subscriptions;
		var _p38 = portal.requested;
		switch (_p38.ctor) {
			case 'ViewSources':
				return A2(
					_elm_lang$html$Html$div,
					{ctor: '[]'},
					{
						...
						_0: A2(
							_elm_lang$html$Html$map,
							_user$project$Main$SourcesUpdated,
							_user$project$Controls_Sources$view(
								{profileId: portal.provider.profile.id, platforms: model.platforms, source: portal.newSource, sources: loggedIn.profile.sources})),
						_1: {ctor: '[]'}
					});
			case 'ViewPortfolio':
				var contentToDisplay = function () {
					var _p39 = contentToEmbed;
					if (_p39.ctor === 'Just') {
						return _p39._0;
					} else {
						return A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									_elm_lang$html$Html$map,
									_user$project$Main$PortfolioAction,
									A2(
			...
			case 'EditProfile':
				...
				return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							_elm_lang$html$Html$map,
							_user$project$Main$EditProfileAction,
			...
			case 'ViewFollowers':
				return A4(
					...
					model.searchResult);
			case 'ViewProviders':
				return A3(_user$project$Main$filteredProvidersUI, loggedIn, 'name', model.searchResult);
			default:
				return A2(_user$project$Main$recentLinksContent, loggedIn.profile.id, model.searchResult);
		}
	});
var _user$project$Main$OnLogin = function (a) {
	return {ctor: 'OnLogin', _0: a};
};
var _user$project$Main$onLogin = F2(
	function (subMsg, model) {
		var _p40 = A2(_user$project$Controls_Login$update, subMsg, model.login);
		var login = _p40._0;
		var subCmd = _p40._1;
		var _p41 = {
			ctor: '_Tuple2',
			_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$OnLogin, subCmd),
			_1: model.portal
		};
		var loginCmd = _p41._0;
		var pendingPortal = _p41._1;
		var _p42 = subMsg;
		switch (_p42.ctor) {
			case 'Response':
				var _p43 = _p42._0;
				if (_p43.ctor === 'Ok') {
					var portfolioSearch = model.portfolioSearch;
					var provider = _user$project$Services_Adapter$toProvider(_p43._0);
					var filtered = provider.filteredPortfolio;
					var newState = _elm_lang$core$Native_Utils.update(
						model,
						{
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p44.ctor) {
			case 'UrlChange':
				return A3(_user$project$Main$navigate, msg, model, _p44._0);
			case 'SaveThumbnailResponse':
				var _p45 = _p44._0;
				if (_p45.ctor === 'Ok') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
			...
			case 'ThumbnailResponse':
				...
				if (_p46.ctor === 'Ok') {
					...
					var updatedProfile = _elm_lang$core$Native_Utils.update(
						profile,
						{
							imageUrl: _user$project$Domain_Core$Url(_p47.imageUrl)
						});
					var request = {
						profileId: profile.id,
						imageUrl: _user$project$Domain_Core$Url(_p47.imageUrl)
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{portal: updatedPortal}),
						_1: A2(_user$project$Settings$runtime.updateThumbnail, request, _user$project$Main$SaveThumbnailResponse)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'ProvidersResponse':
				...
				if (_p48.ctor === 'Ok') {
					...
					var providers = A2(
						...
						A2(_elm_lang$core$List$map, _user$project$Services_Adapter$toProvider, _p48._0));
					return (model.login.loggedIn && _elm_lang$core$Native_Utils.eq(model.portal.requested, _user$project$Domain_Core$ViewProviders)) ? {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								...
								portfolioSearch: _elm_lang$core$Native_Utils.update(
									portfolioSearch,
									{provider: model.portal.provider}),
			...
			case 'BootstrapResponse':
				...
				if (_p49.ctor === 'Ok') {
					var _p50 = _p49._0;
					var providers = A2(_elm_lang$core$List$map, _user$project$Services_Adapter$toProvider, _p50.providers);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					return A2(
						_elm_lang$core$Native_Utils.crash(
							'Main',
							{
								start: {line: 223, column: 25},
								end: {line: 223, column: 36}
							}),
			...
			case 'NavigateToPortalProviderTopicResponse':
				...
				if (_p51.ctor === 'Ok') {
					var _p52 = _p51._0;
					var portal = model.portal;
					var provider = _user$project$Services_Adapter$toProvider(_p52);
					var pendingPortal = _elm_lang$core$Native_Utils.update(
						portal,
						{
							provider: _user$project$Services_Adapter$toProvider(_p52),
							sourcesNavigation: _elm_lang$core$List$isEmpty(provider.profile.sources),
							addLinkNavigation: true,
							portfolioNavigation: _user$project$Domain_Core$portfolioExists(provider.portfolio),
							requested: _user$project$Domain_Core$ViewRecent
			...
			case 'NavigateToProviderMemberTopicResponse':
				var _p53 = _p44._0;
				if (_p53.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								selectedProvider: _user$project$Services_Adapter$toProvider(_p53._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
				...
				if (_p54.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								selectedProvider: _user$project$Services_Adapter$toProvider(_p54._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'ViewLinksResponse':
				var _p55 = _p44._0;
				if (_p55.ctor === 'Ok') {
					var provider = _user$project$Services_Adapter$toProvider(_p55._0);
					var profile = provider.profile;
					var filtered = {
						answers: A2(
							_elm_lang$core$List$filter,
							...
							A2(_user$project$Domain_Core$getLinks, _user$project$Domain_Core$Answer, provider.filteredPortfolio)),
						articles: A2(
							_elm_lang$core$List$filter,
							function (l) {
								return l.isFeatured;
							},
							A2(_user$project$Domain_Core$getLinks, _user$project$Domain_Core$Article, provider.filteredPortfolio)),
						videos: A2(
							_elm_lang$core$List$filter,
							function (l) {
								return l.isFeatured;
							},
							A2(_user$project$Domain_Core$getLinks, _user$project$Domain_Core$Video, provider.filteredPortfolio)),
						podcasts: A2(
							_elm_lang$core$List$filter,
							function (l) {
								return l.isFeatured;
					...
					return A2(
						_elm_lang$core$Native_Utils.crash(
							'Main',
							{
								start: {line: 305, column: 25},
								end: {line: 305, column: 36}
							}),
			...
			case 'NavigateToProviderResponse':
				...
				if (_p56.ctor === 'Ok') {
					...
					var portfolioSearch = model.portfolioSearch;
					var provider = _user$project$Services_Adapter$toProvider(_p56._0);
					var portfolio = provider.portfolio;
					var updatedPortfolioSearch = _elm_lang$core$Native_Utils.update(
						portfolioSearch,
						{provider: provider});
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{selectedProvider: updatedProvider, portfolioSearch: updatedPortfolioSearch}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				...
				if (_p57.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								selectedProvider: _user$project$Services_Adapter$toProvider(_p57._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
				...
				if (_p58.ctor === 'Ok') {
					...
					return A2(
						_elm_lang$core$Native_Utils.crash(
							'Main',
							{
								start: {line: 367, column: 25},
								end: {line: 367, column: 36}
							}),
						_elm_lang$core$Basics$toString(_p58._0),
						{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
				}
			case 'Register':
				return {
			...
			case 'OnRegistration':
				return A2(_user$project$Main$onRegistration, _p44._0, model);
			case 'OnLogin':
				return A2(_user$project$Main$onLogin, _p44._0, model);
			case 'Search':
				if (_p44._0 === '') {
					var scopedProviders = model.scopedProviders;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{searchResult: scopedProviders}),
						_1: _user$project$Settings$runtime.providers(_user$project$Main$ProvidersResponse)
					};
				} else {
					var scopedProviders = model.scopedProviders;
					var result = A2(_user$project$Main$matchProviders, _p44._0, scopedProviders);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
			...
			case 'ProfileThumbnail':
				...
				var portal = model.portal;
				var loggedIn = portal.provider;
				var executeUpdate = F2(
					function (updatedProvider, profileThumbnailCommand) {
						var _p59 = _p64;
						if (_p59.ctor === 'UpdateSubscription') {
							return {
								...
								_1: profileThumbnailCommand
							};
						} else {
							if (_p59._0.ctor === 'Ok') {
								var userIsSubscribedTo = A2(
									_elm_lang$core$List$any,
									function (s) {
										return _elm_lang$core$Native_Utils.eq(s, loggedIn.profile.id);
									},
									updatedProvider.followers);
								var portalUserSubscriptions = userIsSubscribedTo ? {ctor: '::', _0: updatedProvider.profile.id, _1: loggedIn.subscriptions} : A2(
									_elm_lang$core$List$filter,
									function (s) {
										return !_elm_lang$core$Native_Utils.eq(s, updatedProvider.profile.id);
									},
									loggedIn.subscriptions);
								var providerId = updatedProvider.profile.id;
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{
											portal: _elm_lang$core$Native_Utils.update(
												portal,
												{
													provider: _user$project$Services_Adapter$toProvider(_p59._0._0.user),
													provider: _elm_lang$core$Native_Utils.update(
														loggedIn,
														{subscriptions: portalUserSubscriptions})
												}),
											providers: A3(
												_elm_community$list_extra$List_Extra$replaceIf,
												function (p) {
													return _elm_lang$core$Native_Utils.eq(p.profile.id, providerId);
												},
												updatedProvider,
												model.searchResult),
											scopedProviders: A3(
								...
								return A2(
									_elm_lang$core$Native_Utils.crash(
										'Main',
										{
											start: {line: 438, column: 33},
											end: {line: 438, column: 44}
										}),
									_elm_lang$core$Basics$toString(_p59._0._0),
									{ctor: '_Tuple2', _0: model, _1: profileThumbnailCommand});
							}
						}
					});
				var updateProvider = function (targetProvider) {
					var _p60 = A2(_user$project$Controls_ProfileThumbnail$update, _p64, targetProvider);
					var updatedProvider = _p60._0;
					var subCmd = _p60._1;
					var profileThumbnailCmd = A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$ProfileThumbnail, subCmd);
					return A2(executeUpdate, updatedProvider, profileThumbnailCmd);
				};
				var _p61 = _p64;
				if (_p61.ctor === 'UpdateSubscription') {
					var _p62 = _p61._0;
					if (_p62.ctor === 'Subscribe') {
						return updateProvider(_p62._1);
					} else {
						return updateProvider(_p62._1);
					}
				} else {
					...
					if (_p63.ctor === 'Ok') {
						return updateProvider(
							_user$project$Services_Adapter$toProvider(_p63._0.provider));
					} else {
						return A2(
							_elm_lang$core$Native_Utils.crash(
								'Main',
								{
									start: {line: 467, column: 37},
									end: {line: 467, column: 48}
								}),
			...
			case 'ViewPortfolio':
				var portal = model.portal;
				var _p65 = _user$project$Main$tokenizeUrl(model.currentRoute.hash);
				if ((((_p65.ctor === '::') && (_p65._0 === 'portal')) && (_p65._1.ctor === '::')) && (_p65._1._1.ctor === '[]')) {
					var provider = portal.provider;
					var filtered = {
						answers: A2(
							_elm_lang$core$List$filter,
							...
							model,
							{
								portal: _elm_lang$core$Native_Utils.update(
									portal,
									{
										...
										provider: _elm_lang$core$Native_Utils.update(
											provider,
											{portfolio: provider.portfolio, filteredPortfolio: filtered})
									})
							}),
						_1: A2(_user$project$Settings$runtime.links, provider.profile.id, _user$project$Main$ViewLinksResponse)
					};
				} else {
					return {
						ctor: '_Tuple2',
						...
						_1: _elm_lang$navigation$Navigation$load(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'/#/portal/',
								_user$project$Domain_Core$idText(model.portal.provider.profile.id)))
					};
				}
			case 'EditProfile':
				var portal = model.portal;
			...
			case 'ViewSubscriptions':
				...
				return {
					...
					_1: A2(_user$project$Settings$runtime.subscriptions, profile.id, _user$project$Main$SubscriptionsResponse)
				};
			case 'SubscriptionsResponse':
				if (_p44._0.ctor === 'Ok') {
					var subscriptions = A2(_elm_lang$core$List$map, _user$project$Services_Adapter$toProvider, _p44._0._0);
					if (model.login.loggedIn) {
						var subscriptionIds = A2(
							_elm_lang$core$List$map,
							function (s) {
								return s.profile.id;
							},
						...
						var portal = model.portal;
						var provider = portal.provider;
						return (!_elm_lang$core$Native_Utils.eq(portal.requested, _user$project$Domain_Core$ViewProviders)) ? {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{scopedProviders: subscriptions, searchResult: subscriptions}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
				} else {
					return A2(
						_elm_lang$core$Native_Utils.crash(
							'Main',
							{
								start: {line: 603, column: 17},
								end: {line: 603, column: 28}
							}),
			...
			case 'ViewFollowers':
				...
				return {
					...
					_1: A2(_user$project$Settings$runtime.followers, profile.id, _user$project$Main$FollowersResponse)
				};
			case 'FollowersResponse':
				if (_p44._0.ctor === 'Ok') {
					var followers = A2(_elm_lang$core$List$map, _user$project$Services_Adapter$toProvider, _p44._0._0);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{scopedProviders: followers, searchResult: followers}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return A2(
						_elm_lang$core$Native_Utils.crash(
							'Main',
							{
								...
								end: {line: 630, column: 28}
							}),
						_elm_lang$core$Basics$toString(_p44._0._0),
						{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
				}
			case 'ViewProviders':
				var scopedProviders = model.providers;
				var portal = model.portal;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'SourcesUpdated':
				return A2(_user$project$Main$onSourcesUpdated, _p44._0, model);
			case 'NewLink':
				return A2(_user$project$Main$onNewLink, _p44._0, model);
			case 'EditProfileAction':
				return A2(_user$project$Main$onEditProfile, _p44._0, model);
			case 'PortfolioAction':
				return A3(_user$project$Main$onPortfolioAction, _p44._0, model, providerSource);
			case 'ProviderContentTypeLinksAction':
				return A3(_user$project$Main$onUpdateProviderContentTypeLinks, _p44._0, model, providerSource);
			case 'ProviderTopicContentTypeLinksAction':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Subscription':
				var _p66 = _p44._0;
				if (_p66.ctor === 'Subscribe') {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A2(_user$project$Settings$runtime.subscriptions, _p66._0.profile.id, _user$project$Main$SubscriptionsResponse)
					};
				} else {
					return {
						ctor: '_Tuple2',
...
var _user$project$Main$ViewRecent = {ctor: 'ViewRecent'};
var _user$project$Main$ViewProviders = {ctor: 'ViewProviders'};
var _user$project$Main$ViewFollowers = {ctor: 'ViewFollowers'};
var _user$project$Main$ViewSubscriptions = {ctor: 'ViewSubscriptions'};
var _user$project$Main$EditProfile = {ctor: 'EditProfile'};
var _user$project$Main$ViewPortfolio = {ctor: 'ViewPortfolio'};
var _user$project$Main$AddNewLink = {ctor: 'AddNewLink'};
var _user$project$Main$ViewSources = {ctor: 'ViewSources'};
var _user$project$Main$headerContent = function (model) {
	var loginUI = function (model) {
		...
		var _p67 = {
			...
			_2: A2(
				_elm_lang$html$Html$label,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$EditProfile),
						_1: {ctor: '[]'}
					}
				},
				{
			...
			_3: A2(
				_elm_lang$html$Html$label,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$ViewSources),
						_1: {ctor: '[]'}
					}
				},
				{
		...
		var loggedIn = _p67._0;
		var welcome = _p67._1;
		var signout = _p67._2;
		var settings = _p67._3;
		var sources = _p67._4;
		return (!loggedIn) ? A2(
			_elm_lang$html$Html$map,
			_user$project$Main$OnLogin,
...
var _user$project$Main$renderPage = F2(
	function (content, model) {
		var placeHolder = function () {
			var _p68 = _user$project$Main$tokenizeUrl(model.currentRoute.hash);
			_v42_3:
			do {
				if (_p68.ctor === '[]') {
					return A2(
					...
					if (_p68._1.ctor === '[]') {
						...
						if ((_p68._0 === 'portal') && (_p68._1._1.ctor === '[]')) {
							return A2(
								_elm_lang$html$Html$div,
								{ctor: '[]'},
								{ctor: '[]'});
				...
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$NavigateBack),
								_1: {ctor: '[]'}
							}
						}
					}
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$Main$headerContent(model),
				_1: {
					ctor: '::',
					_0: placeHolder,
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _user$project$Main$footerContent,
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Main$homePage = function (model) {
								...
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: A3(_user$project$Main$providersUI, _elm_lang$core$Maybe$Nothing, false, model.searchResult),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
								_1: {
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												_elm_lang$html$Html$map,
												_user$project$Main$OnRegistration,
	...
	return A2(_user$project$Main$renderPage, mainContent, model);
};
var _user$project$Main$renderNavigation = F2(
	function (portal, subscriptions) {
		var sourcesAvailable = !_elm_lang$core$List$isEmpty(portal.provider.profile.sources);
		...
		var _p69 = {ctor: '_Tuple5', _0: 'Portfolio', _1: 'Subscriptions', _2: 'Members', _3: 'Link', _4: 'Profile'};
		var portfolioText = _p69._0;
		var subscriptionsText = _p69._1;
		var membersText = _p69._2;
		var linkText = _p69._3;
		var profileText = _p69._4;
		var newText = 'Latest';
		var recentCount = _elm_lang$core$List$length(
			_user$project$Main$recentLinks(subscriptions));
		var profile = portal.provider.profile;
		var sourcesText = A2(
			_elm_lang$core$Basics_ops['++'],
			'Sources ',
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$AddNewLink),
									_1: {ctor: '[]'}
								}
							},
							{
		...
		var needName = _elm_lang$core$String$isEmpty(
			...
			_user$project$Domain_Core$nameText(profile.lastName));
		var followers = portal.provider.followers;
					...
					return {
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$ViewRecent),
									_1: {ctor: '[]'}
								}
							},
							{
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$ViewPortfolio),
												_1: {ctor: '[]'}
											}
										},
										{
													...
													_1: {
														...
														_0: A2(
															_elm_lang$html$Html$button,
															{
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$ViewSubscriptions),
																	_1: {ctor: '[]'}
																}
															},
															{
															...
															_1: {
																...
																_0: A2(
																	_elm_lang$html$Html$button,
																	{
																		...
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$ViewFollowers),
																			_1: {ctor: '[]'}
																		}
																	},
																	{
																	...
																	_1: {
																		...
																		_0: A2(
																			_elm_lang$html$Html$button,
																			{
																				...
																				_1: {
																					ctor: '::',
																					_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$ViewProviders),
																					_1: {ctor: '[]'}
																				}
																			},
																			{
		...
		return (needName && (!sourcesAvailable)) ? displayNavigation(noSourcesNoLinks) : (((!portal.sourcesNavigation) && ((!portal.portfolioNavigation) && (!sourcesAvailable))) ? displayNavigation(enableOnlySourcesAndLinks) : ((portal.sourcesNavigation && ((!portal.portfolioNavigation) && (!sourcesAvailable))) ? displayNavigation(enableOnlySourcesAndLinks) : displayNavigation(allNavigation)));
	});
var _user$project$Main$render = F4(
											...
											_0: A2(
												...
												{ctor: '[]'},
												{
													...
													_0: A2(
														_elm_lang$html$Html$td,
														{ctor: '[]'},
														A2(_user$project$Main$renderNavigation, portal, subscriptions)),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
...
var _user$project$Main$applyToPortal = F3(
	function (provider, model, content) {
		var portal = model.portal;
		return _elm_lang$core$Native_Utils.eq(portal.provider, _user$project$Domain_Core$initProvider) ? A4(_user$project$Main$render, provider, content, model.scopedProviders, portal) : A4(_user$project$Main$render, portal.provider, content, model.scopedProviders, portal);
	});
var _user$project$Main$view = function (model) {
	var _p73 = _user$project$Main$tokenizeUrl(model.currentRoute.hash);
	_v46_10:
	do {
		if (_p73.ctor === '[]') {
				...
				if (_p73._1._1.ctor === '[]') {
					switch (_p73._0) {
						case 'provider':
							return A2(
								_user$project$Main$renderPage,
								A2(
									_user$project$Main$renderProfileBase,
						...
						case 'portal':
							var mainContent = A3(
								_user$project$Main$applyToPortal,
								model.portal.provider,
								model,
								A2(_user$project$Main$content, _elm_lang$core$Maybe$Nothing, model));
							return A2(_user$project$Main$renderPage, mainContent, model);
						default:
							break _v46_10;
					}
					...
					if (_p73._1._1._1.ctor === '[]') {
						if (_p73._0 === 'provider') {
							return A2(
								_user$project$Main$renderPage,
								A2(_user$project$Main$providerTopicPage, _user$project$Domain_Core$FromOther, model.selectedProvider),
								model);
						} else {
							break _v46_10;
						}
					} else {
						if (_p73._1._1._1._1.ctor === '[]') {
							switch (_p73._0) {
								case 'provider':
									if (_p73._1._1._0 === 'all') {
										var contentToEmbed = A2(
											_elm_lang$html$Html$map,
											_user$project$Main$ProviderContentTypeLinksAction,
											A3(
												_user$project$Controls_ProviderContentTypeLinks$view,
												model.selectedProvider,
												_user$project$Domain_Core$toContentType(_p73._1._1._1._0),
												false));
										return A2(
											_user$project$Main$renderPage,
											A2(_user$project$Main$renderProfileBase, model.selectedProvider, contentToEmbed),
											model);
									} else {
										break _v46_10;
									}
								case 'portal':
									switch (_p73._1._1._0) {
										case 'all':
											var linksContent = A2(
												_elm_lang$html$Html$map,
												_user$project$Main$ProviderContentTypeLinksAction,
												A3(
													...
													_user$project$Domain_Core$toContentType(_p73._1._1._1._0),
													true));
											var contentToEmbed = A3(_user$project$Main$applyToPortal, model.portal.provider, model, linksContent);
											return A2(
												_user$project$Main$renderPage,
												A2(
											...
											var contentLinks = A2(
												...
												A2(
													...
													A2(
														...
														_user$project$Domain_Core$FromOther,
														{provider: model.selectedProvider, topicSuggestions: model.portfolioSearch.topicSuggestions, selectedTopic: model.portfolioSearch.selectedTopic, inputValue: model.portfolioSearch.inputValue})));
											return A2(_user$project$Main$renderPage, contentLinks, model);
										default:
											break _v46_10;
									}
								default:
							...
							if (_p73._1._1._1._1._1.ctor === '[]') {
								switch (_p73._0) {
									case 'provider':
										if (_p73._1._1._1._0 === 'all') {
											var topic = A2(_user$project$Domain_Core$Topic, _p73._1._1._0, false);
											var contentToEmbed = A2(
												_elm_lang$html$Html$map,
												_user$project$Main$ProviderTopicContentTypeLinksAction,
												A3(
													_user$project$Controls_ProviderTopicContentTypeLinks$view,
													model.selectedProvider,
													topic,
													_user$project$Domain_Core$toContentType(_p73._1._1._1._1._0)));
											return A2(
												_user$project$Main$renderPage,
												A2(_user$project$Main$renderProfileBase, model.selectedProvider, contentToEmbed),
												model);
											...
											var contentLinks = A2(
												...
												A2(
													...
													A3(
														_user$project$Controls_ProviderTopicContentTypeLinks$view,
														model.selectedProvider,
														A2(_user$project$Domain_Core$Topic, _p73._1._1._1._1._0, false),
