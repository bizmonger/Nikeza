...
var _user$project$Domain_Core$Source = F6(
	function (a, b, c, d, e, f) {
		return {id: a, profileId: b, platform: c, username: d, apiKey: e, links: f};
	});
...
var _user$project$Domain_Core$initSource = A6(
...
var _user$project$Services_Adapter$JsonSource = F6(
	function (a, b, c, d, e, f) {
		return {id: a, profileId: b, platform: c, username: d, apiKey: e, links: f};
	});
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'APIKey',
								_1: _elm_lang$core$Json_Encode$string(source.apiKey)
							},
							_1: {ctor: '[]'}
						}
					}
...
var _user$project$Services_Gateway$sourceDecoder = A7(
...
var _user$project$Controls_Sources$view = F2(
	function (model, platforms) {
		var placeholderText = _elm_lang$core$Native_Utils.eq(model.source.platform, 'YouTube') ? 'channel-id: (Settings -> Advanced)' : 'username';
