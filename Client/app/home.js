...
var _user$project$Controls_ProfileThumbnail$update = F2(
	function (msg, provider) {
		...
		if (_p4.ctor === 'SubscribeResponse') {
			var _p5 = _p4._0;
			if (_p5.ctor === 'Ok') {
				var otherProvider = _user$project$Services_Adapter$toProvider(_p5._0);
				var subscriptions = A2(
					_elm_lang$core$List$any,
					function (f) {
						return _elm_lang$core$Native_Utils.eq(f, otherProvider.profile.id);
					},
					otherProvider.followers) ? {ctor: '::', _0: provider.profile.id, _1: otherProvider.followers} : A2(
					_elm_lang$core$List$filter,
					function (f) {
			...
			if (_p6.ctor === 'Subscribe') {
				return {
					...
					_1: A2(
						...
						{subscriberId: _p6._0, providerId: _p6._1},
			...
			var placeholder = ((!alreadySubscribed) && showSubscriptionState) ? A2(
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Controls_ProfileThumbnail$UpdateSubscription(
								A2(_user$project$Domain_Core$Subscribe, _p8.profile.id, provider.profile.id))),
						_1: {ctor: '[]'}
					}
				},
				{
				...
				_elm_lang$html$Html$button,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Controls_ProfileThumbnail$UpdateSubscription(
								A2(_user$project$Domain_Core$Unsubscribe, _p8.profile.id, provider.profile.id))),
						_1: {ctor: '[]'}
					}
				},
				{
													...
													_0: _elm_lang$html$Html_Attributes$href(
														_user$project$Domain_Core$urlText(
															A2(
																...
																_elm_lang$core$Maybe$Just(_p8.profile.id),
																profile.id))),
													_1: {ctor: '[]'}
												},
												{
	...
	function (msg, model) {
		...
		switch (_p42.ctor) {
			...
			case 'NavigateToPortalResponse':
				...
				if (_p56.ctor === 'Ok') {
					var _p57 = {
						ctor: '_Tuple2',
						_0: model.portal,
						_1: _user$project$Services_Adapter$toProvider(_p56._0)
					};
					var portal = _p57._0;
					var provider = _p57._1;
					var pendingPortal = _elm_lang$core$Native_Utils.update(
						portal,
						{
							provider: provider,
					...
					return A2(
						_elm_lang$core$Native_Utils.crash(
							'Home',
							{
								start: {line: 350, column: 25},
								end: {line: 350, column: 36}
							}),
			...
			case 'ProfileThumbnail':
				var portal = model.portal;
				var provider = portal.provider;
				var _p58 = A2(_user$project$Controls_ProfileThumbnail$update, _p42._0, provider);
			...
			case 'ViewPortfolio':
				...
				if ((((_p59.ctor === '::') && (_p59._0 === 'portal')) && (_p59._1.ctor === '::')) && (_p59._1._1.ctor === '[]')) {
					var provider = portal.provider;
					var filtered = {
						answers: A2(
							_elm_lang$core$List$filter,
			...
			do {
				if (_p62.ctor === '[]') {
					...
					if (_p62._1.ctor === '[]') {
						...
						if ((_p62._0 === 'portal') && (_p62._1._1.ctor === '[]')) {
							return A2(
								_elm_lang$html$Html$div,
								{ctor: '[]'},
								{ctor: '[]'});
...
var _user$project$Home$renderNavigation = F2(
	function (portal, subscriptions) {
		...
		var _p63 = {ctor: '_Tuple5', _0: 'Portfolio', _1: 'Subscriptions', _2: 'Members', _3: 'Link', _4: 'Profile'};
		var portfolioText = _p63._0;
		var subscriptionsText = _p63._1;
...
var _user$project$Home$view = function (model) {
	var _p67 = _user$project$Home$tokenizeUrl(model.currentRoute.hash);
	_v41_10:
	do {
		if (_p67.ctor === '[]') {
			...
			if (_p67._1.ctor === '[]') {
				...
				if (_p67._1._1.ctor === '[]') {
					...
					if (_p67._1._1._1.ctor === '[]') {
						...
						if (_p67._1._1._1._1.ctor === '[]') {
							switch (_p67._0) {
								case 'provider':
									if (_p67._1._1._0 === 'all') {
										var contentToEmbed = A2(
											...
											A3(
												...
												model.selectedProvider,
												_user$project$Domain_Core$toContentType(_p67._1._1._1._0),
												false));
										return A2(
											_user$project$Home$renderPage,
							...
							if (_p67._1._1._1._1._1.ctor === '[]') {
								switch (_p67._0) {
									case 'provider':
										if (_p67._1._1._1._0 === 'all') {
											var topic = A2(_user$project$Domain_Core$Topic, _p67._1._1._0, false);
											var contentToEmbed = A2(
												_elm_lang$html$Html$map,
												...
												A3(
													...
													model.selectedProvider,
													topic,
													_user$project$Domain_Core$toContentType(_p67._1._1._1._1._0)));
											return A2(
												_user$project$Home$renderPage,
												A2(_user$project$Home$renderProfileBase, model.selectedProvider, contentToEmbed),
												model);
											...
											var contentLinks = A2(
												...
												A2(
													...
													A3(
														_user$project$Controls_ProviderTopicContentTypeLinks$view,
														model.selectedProvider,
														A2(_user$project$Domain_Core$Topic, _p67._1._1._1._1._0, false),
