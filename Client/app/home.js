...
var _user$project$Services_Gateway$suggestedTopics = F2(
	function (search, msg) {
		var url = A2(_elm_lang$core$Basics_ops['++'], _user$project$Services_Gateway$baseUrl, 'suggestedtopics');
		var request = A2(
			_elm_lang$http$Http$get,
			url,
			_elm_lang$core$Json_Decode$list(_user$project$Services_Decoders$topicDecoder));
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													...
													{ctor: '[]'},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(
															_elm_lang$core$Basics$toString(model.current.base)),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}),
