...
var _user$project$Services_Adapter$JsonBootstrapDependencies = F2(
	function (a, b) {
...
var _user$project$Tests_TestAPI$unsubscribe = F3(
...
var _user$project$Tests_TestAPI$follow = F3(
	function (clientId, providerId, msg) {
		return A2(
			_user$project$Services_Adapter$httpSuccess,
			msg,
...
var _user$project$Tests_TestAPI$providersAndPlatformsBase = {providers: _user$project$Tests_TestAPI$providersBase, platforms: _user$project$Tests_TestAPI$platformsBase};
...
var _user$project$Services_Gateway$bootstrapDependenciesDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Services_Adapter$JsonBootstrapDependencies,
	A2(
		_elm_lang$core$Json_Decode$field,
		'Providers',
...
var _user$project$Services_Gateway$providersAndPlatforms = function (msg) {
	var url = A2(_elm_lang$core$Basics_ops['++'], _user$project$Services_Gateway$baseUrl, 'platforms_providers');
	var request = A2(_elm_lang$http$Http$get, url, _user$project$Services_Gateway$bootstrapDependenciesDecoder);
	return A2(_elm_lang$http$Http$send, msg, request);
};
														...
														return function (o) {
															return function (p) {
																return function (q) {
																	return function (r) {
																		return function (s) {
																			return {tryLogin: a, tryRegister: b, provider: c, providerTopic: d, providers: e, links: f, addLink: g, removeLink: h, topicLinks: i, sources: j, addSource: k, removeSource: l, platforms: m, suggestedTopics: n, subscriptions: o, followers: p, follow: q, unsubscribe: r, providersAndPlatforms: s};
																		};
																	};
																};
															};
...
var _user$project$Settings$runtime = function () {
	...
	if (_p0.ctor === 'Integration') {
		return _user$project$Settings$Dependencies(_user$project$Services_Gateway$tryLogin)(_user$project$Services_Gateway$tryRegister)(_user$project$Services_Gateway$provider)(_user$project$Services_Gateway$providerTopic)(_user$project$Services_Gateway$providers)(_user$project$Services_Gateway$links)(_user$project$Services_Gateway$addLink)(_user$project$Services_Gateway$removeLink)(_user$project$Services_Gateway$topicLinks)(_user$project$Services_Gateway$sources)(_user$project$Services_Gateway$addSource)(_user$project$Services_Gateway$removeSource)(_user$project$Services_Gateway$platforms)(_user$project$Services_Gateway$suggestedTopics)(_user$project$Services_Gateway$subscriptions)(_user$project$Services_Gateway$followers)(_user$project$Services_Gateway$follow)(_user$project$Services_Gateway$unsubscribe)(_user$project$Services_Gateway$providersAndPlatforms);
	} else {
...
var _user$project$Controls_ProfileThumbnail$update = F2(
	function (msg, provider) {
		...
		if (_p0.ctor === 'SubscribeResponse') {
			...
			var _p2 = _p0._0;
			if (_p2.ctor === 'Subscribe') {
				return {
					ctor: '_Tuple2',
					_0: provider,
					_1: A3(_user$project$Settings$runtime.follow, _p2._0, _p2._1, _user$project$Controls_ProfileThumbnail$SubscribeResponse)
				};
			} else {
				return {
					ctor: '_Tuple2',
					_0: provider,
					_1: A3(_user$project$Settings$runtime.unsubscribe, _p2._0, _p2._1, _user$project$Controls_ProfileThumbnail$SubscribeResponse)
				};
			}
		}
	});
...
var _user$project$Controls_ProfileThumbnail$thumbnail = F3(
	function (loggedIn, showSubscriptionState, provider) {
		...
		if (_p3.ctor === 'Just') {
			var _p5 = _p3._0;
			var _p4 = _p5.subscriptions;
			var mySubscriptions = _p4._0;
			...
			var placeholder = ((!alreadySubscribed) && showSubscriptionState) ? A2(
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Controls_ProfileThumbnail$UpdateSubscription(
								A2(_user$project$Domain_Core$Subscribe, _p5.profile.id, provider.profile.id))),
						_1: {ctor: '[]'}
					}
				},
				{
				...
				_elm_lang$html$Html$button,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Controls_ProfileThumbnail$UpdateSubscription(
								A2(_user$project$Domain_Core$Unsubscribe, _p5.profile.id, provider.profile.id))),
						_1: {ctor: '[]'}
					}
				},
				{
													...
													_0: _elm_lang$html$Html_Attributes$href(
														_user$project$Domain_Core$urlText(
															A2(
																...
																_elm_lang$core$Maybe$Just(_p5.profile.id),
																profile.id))),
													_1: {ctor: '[]'}
												},
												{
...
var _user$project$Controls_ProviderLinks$view = F2(
	function (linksFrom, provider) {
		...
		var _p1 = {ctor: '_Tuple2', _0: provider.profile.id, _1: provider.topics};
				...
				var updatedPortal = _elm_lang$core$Native_Utils.update(
					portal,
					{
						...
						provider: _elm_lang$core$Native_Utils.update(
							provider,
							{
								portfolio: A2(_user$project$Home$refreshLinks, provider, updatedLinks.added)
							})
					});
				return {
					ctor: '_Tuple2',
...
var _user$project$Home$onRemove = F2(
	function (model, sources) {
		...
		var _p6 = {ctor: '_Tuple2', _0: provider.profile, _1: model.portal};
		var profile = _p6._0;
		var pendingPortal = _p6._1;
		var sourcesLeft = A2(
			_elm_lang$core$List$filter,
			function (c) {
...
var _user$project$Home$onEditProfile = F2(
	function (subMsg, model) {
		var _p7 = {ctor: '_Tuple2', _0: model.portal, _1: model.portal.provider};
		var portal = _p7._0;
		var provider = _p7._1;
...
var _user$project$Home$onRegistration = F2(
	function (subMsg, model) {
		var _p12 = A2(_user$project$Controls_Register$update, subMsg, model.registration);
		var form = _p12._0;
		var subCmd = _p12._1;
		...
		switch (_p13.ctor) {
			...
			default:
				var _p14 = _p13._0;
				if (_p14.ctor === 'Ok') {
					var newUser = _user$project$Services_Adapter$jsonProfileToProvider(_p14._0);
					var newState = _elm_lang$core$Native_Utils.update(
						model,
						{
							registration: form,
...
var _user$project$Home$navigate = F3(
	function (msg, model, location) {
		var _p15 = _user$project$Home$tokenizeUrl(location.hash);
		_v9_8:
		do {
					...
					if (_p15._1._1._1.ctor === '[]') {
						switch (_p15._0) {
							case 'provider':
								var _p16 = {
									ctor: '_Tuple2',
									_0: _user$project$Domain_Core$Id(_p15._1._0),
									_1: A2(_user$project$Domain_Core$Topic, _p15._1._1._0, false)
								};
							...
							case 'portal':
								...
								var providerId = _p17._0;
								var providerTopic = _p17._1;
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										model,
						...
						if (_p15._1._1._1._1.ctor === '::') {
							if (((_p15._0 === 'portal') && (_p15._1._1._0 === 'provider')) && (_p15._1._1._1._1._1.ctor === '[]')) {
								var _p18 = {
									ctor: '_Tuple2',
									_0: _user$project$Domain_Core$Id(_p15._1._1._1._0),
									_1: A2(_user$project$Domain_Core$Topic, _p15._1._1._1._1._0, false)
								};
								var providerId = _p18._0;
								var providerTopic = _p18._1;
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										model,
									...
									switch (_p15._1._1._0) {
										...
										case 'provider':
											return {
												...
												_1: A2(
													_user$project$Settings$runtime.provider,
													_user$project$Domain_Core$Id(_p15._1._1._1._0),
...
var _user$project$Home$ProvidersAndPlatformsResponse = function (a) {
	return {ctor: 'ProvidersAndPlatformsResponse', _0: a};
};
var _user$project$Home$init = function (location) {
	return {
		...
		_1: _user$project$Settings$runtime.providersAndPlatforms(_user$project$Home$ProvidersAndPlatformsResponse)
	};
};
...
var _user$project$Home$renderNavigation = F2(
	function (portal, providers) {
		...
		var _p19 = {ctor: '_Tuple5', _0: 'Portfolio', _1: 'Subscriptions', _2: 'Members', _3: 'Link', _4: 'Profile'};
		var portfolioText = _p19._0;
		var subscriptionsText = _p19._1;
		var membersText = _p19._2;
		var linkText = _p19._3;
		var profileText = _p19._4;
		...
		var _p22 = portal.provider.followers;
		var followers = _p22._0;
		var followersText = A2(
			...
			A2(
				...
				A2(
					...
					')')));
		var _p23 = portal.provider.subscriptions;
		var subscriptions = _p23._0;
...
var _user$project$Home$onLogin = F2(
	function (subMsg, model) {
		var _p29 = A2(_user$project$Controls_Login$update, subMsg, model.login);
		var login = _p29._0;
		var subCmd = _p29._1;
		var _p30 = {
			ctor: '_Tuple2',
		...
		var loginCmd = _p30._0;
		var pendingPortal = _p30._1;
		var _p31 = subMsg;
		switch (_p31.ctor) {
			case 'Response':
				var _p32 = _p31._0;
				if (_p32.ctor === 'Ok') {
					var provider = _user$project$Services_Adapter$toProvider(_p32._0);
					var newState = _elm_lang$core$Native_Utils.update(
						model,
						{
							portal: _elm_lang$core$Native_Utils.update(
...
var _user$project$Home$update = F2(
	function (msg, model) {
		...
		switch (_p33.ctor) {
			case 'UrlChange':
				return A3(_user$project$Home$navigate, msg, model, _p33._0);
			...
			case 'ProvidersAndPlatformsResponse':
				var _p35 = _p33._0;
				if (_p35.ctor === 'Ok') {
					var _p36 = _p35._0;
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								providers: A2(_elm_lang$core$List$map, _user$project$Services_Adapter$toProvider, _p36.providers),
								platforms: A2(
									_elm_lang$core$List$map,
									function (p) {
			...
			case 'NavigateToPortalProviderTopicResponse':
				...
				if (_p37.ctor === 'Ok') {
					var _p38 = _p37._0;
					var portal = model.portal;
					var provider = _user$project$Services_Adapter$toProvider(_p38);
					var pendingPortal = _elm_lang$core$Native_Utils.update(
						portal,
						{
							provider: _user$project$Services_Adapter$toProvider(_p38),
							sourcesNavigation: _elm_lang$core$List$isEmpty(provider.profile.sources),
							addLinkNavigation: true,
							linksNavigation: _user$project$Domain_Core$portfolioExists(provider.portfolio),
							requested: _user$project$Domain_Core$ViewRecent
				...
				if (_p39.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								selectedProvider: _user$project$Services_Adapter$toProvider(_p39._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
				...
				if (_p40.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								selectedProvider: _user$project$Services_Adapter$toProvider(_p40._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
				...
				if (_p41.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								selectedProvider: _user$project$Services_Adapter$toProvider(_p41._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
				...
				if (_p42.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								selectedProvider: _user$project$Services_Adapter$toProvider(_p42._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'NavigateToPortalResponse':
				...
				if (_p43.ctor === 'Ok') {
					var _p44 = {
						ctor: '_Tuple2',
						_0: model.portal,
						_1: _user$project$Services_Adapter$toProvider(_p43._0)
					};
					var portal = _p44._0;
					var provider = _p44._1;
					var pendingPortal = _elm_lang$core$Native_Utils.update(
						portal,
						{
							provider: provider,
			...
			case 'OnRegistration':
				return A2(_user$project$Home$onRegistration, _p33._0, model);
			case 'OnLogin':
				return A2(_user$project$Home$onLogin, _p33._0, model);
			case 'Search':
				if (_p33._0 === '') {
					return {
						ctor: '_Tuple2',
					...
					return A2(_user$project$Home$matchProviders, model, _p33._0);
				}
			...
			case 'SourceAdded':
				return A2(_user$project$Home$onAddedSource, _p33._0, model);
			case 'NewLink':
				return A2(_user$project$Home$onNewLink, _p33._0, model);
			case 'EditProfileAction':
				return A2(_user$project$Home$onEditProfile, _p33._0, model);
			case 'PortalLinksAction':
				return A2(_user$project$Home$onPortalLinksAction, _p33._0, model);
			...
			case 'ProviderContentTypeLinksAction':
				var _p46 = _p33._0;
				var provider = _elm_lang$core$Native_Utils.eq(model.portal.requested, _user$project$Domain_Core$ViewLinks) ? A2(_user$project$Controls_ProviderContentTypeLinks$update, _p46, model.portal.provider) : A2(_user$project$Controls_ProviderContentTypeLinks$update, _p46, model.selectedProvider);
				var _p45 = _p46;
				if (_p45.ctor === 'Toggle') {
...
var _user$project$Home$renderPage = F2(
	function (content, model) {
		var placeHolder = function () {
			var _p49 = _user$project$Home$tokenizeUrl(model.currentRoute.hash);
			_v28_3:
			do {
				if (_p49.ctor === '[]') {
					return A2(
					...
					if (_p49._1.ctor === '[]') {
						...
						if ((_p49._0 === 'portal') && (_p49._1._1.ctor === '[]')) {
							return A2(
								_elm_lang$html$Html$div,
								{ctor: '[]'},
								{ctor: '[]'});
...
var _user$project$Home$view = function (model) {
	var _p50 = _user$project$Home$tokenizeUrl(model.currentRoute.hash);
	_v29_10:
	do {
		if (_p50.ctor === '[]') {
			...
			if (_p50._1.ctor === '[]') {
				...
				if (_p50._1._1.ctor === '[]') {
					...
					if (_p50._1._1._1.ctor === '[]') {
						if (_p50._0 === 'provider') {
							var _p51 = _user$project$Settings$runtime.provider(
								_user$project$Domain_Core$Id(_p50._1._0));
							return A2(
								_user$project$Home$renderPage,
						...
						if (_p50._1._1._1._1.ctor === '[]') {
							switch (_p50._0) {
								case 'provider':
									if (_p50._1._1._0 === 'all') {
										var _p52 = _user$project$Settings$runtime.provider(
											_user$project$Domain_Core$Id(_p50._1._0));
										var _p53 = {ctor: '_Tuple2', _0: _user$project$Controls_ProviderContentTypeLinks$view, _1: model.selectedProvider};
										var view = _p53._0;
										...
										var contentToEmbed = A2(
											...
											A3(
												view,
												provider,
												_user$project$Domain_Core$toContentType(_p50._1._1._1._0),
												false));
										return A2(
											_user$project$Home$renderPage,
							...
							if (_p50._1._1._1._1._1.ctor === '[]') {
								switch (_p50._0) {
									case 'provider':
										if (_p50._1._1._1._0 === 'all') {
											var _p54 = _user$project$Settings$runtime.provider(
												_user$project$Domain_Core$Id(_p50._1._0));
											var topic = A2(_user$project$Domain_Core$Topic, _p50._1._1._0, false);
											var contentToEmbed = A2(
												_elm_lang$html$Html$map,
												...
												A3(
													...
													model.selectedProvider,
													topic,
													_user$project$Domain_Core$toContentType(_p50._1._1._1._1._0)));
											return A2(
												_user$project$Home$renderPage,
												A2(_user$project$Home$renderProfileBase, model.selectedProvider, contentToEmbed),
												model);
											...
											var contentLinks = A2(
												...
												A2(
													...
													A3(
														_user$project$Controls_ProviderTopicContentTypeLinks$view,
														model.selectedProvider,
														A2(_user$project$Domain_Core$Topic, _p50._1._1._1._1._0, false),
