...
var _user$project$Domain_Core$latestLinks = F3(
	function (f, profileId, contentType) {
...
var _user$project$Tests_TestAPI$topics = function (profileId) {
	return _elm_lang$core$List$concat(
		A2(
			_elm_lang$core$List$map,
			function (p) {
			...
			A2(_user$project$Tests_TestAPI$links, _user$project$Domain_Core$All, profileId)));
};
...
var _user$project$Services_Server$links = F2(
...
var _user$project$Controls_AddConnection$init = A2(_user$project$Domain_Core$Connection, '', '');
...
var _user$project$Controls_AddLink$InputTopics = function (a) {
	return {ctor: 'InputTopics', _0: a};
};
var _user$project$Controls_AddLink$InputUrl = function (a) {
	return {ctor: 'InputUrl', _0: a};
};
var _user$project$Controls_AddLink$InputTitle = function (a) {
			...
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$Controls_AddLink$InputTitle),
							_1: {ctor: '[]'}
						}
					}
				},
				...
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$Controls_AddLink$InputUrl),
								_1: {ctor: '[]'}
							}
						}
					},
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$value('undefined2'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value('Article2'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value('Video2'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value('Answer2'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$value('Podcast2'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
...
var _user$project$Domain_Contributor$init = function () {
	...
	return A9(
		...
		profile,
		newConnection,
		{ctor: '_Tuple2', _0: newLink, _1: false},
		true,
		{ctor: '[]'},
		{ctor: '[]'},
		{ctor: '[]'},
				...
				if (_p0._1._1.ctor === '[]') {
					...
					if (_p1.ctor === 'Just') {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									contributor: _user$project$Domain_Contributor$getContributor(_p1._0),
					...
					if (_p0._1._1._1.ctor === '[]') {
						var _p2 = _user$project$Settings$runtime.contributor(
							_user$project$Domain_Core$Id(_p0._1._0));
						if (_p2.ctor === 'Just') {
							var contributor = _user$project$Domain_Contributor$getContributor(_p2._0);
							...
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{contributor: topicContributor, currentRoute: location}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
						} else {
							return {
	...
	function (model, subMsg) {
		...
		switch (_p5.ctor) {
			case 'Attempt':
				...
				var _p6 = {
					ctor: '_Tuple2',
					_0: model.contributor,
					_1: _user$project$Settings$runtime.tryLogin(login)
				};
				var contributor = _p6._0;
				var latest = _p6._1;
				var newState = function () {
					var _p7 = _user$project$Settings$runtime.contributor(
								...
								contributor: _elm_lang$core$Native_Utils.update(
									contributor,
									{
										profile: _elm_lang$core$Native_Utils.update(
											_p8,
											{
												connections: _user$project$Settings$runtime.connections(_p8.id)
											})
									})
							});
					} else {
				...
				return newState.login.loggedIn ? {
					...
					_1: _elm_lang$navigation$Navigation$load(
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_user$project$Domain_Core$getId(newState.contributor.profile.id),
								'/dashboard')))
...
var _user$project$Home$onNewConnection = F2(
	function (subMsg, model) {
		var contributor = model.contributor;
		var connection = A2(_user$project$Controls_AddConnection$update, subMsg, model.contributor.newConnection);
		var _p12 = subMsg;
		switch (_p12.ctor) {
			case 'InputUsername':
				return {
							...
							contributor: _elm_lang$core$Native_Utils.update(
								contributor,
								{
									...
									profile: _elm_lang$core$Native_Utils.update(
										profile,
										{
											connections: {ctor: '::', _0: connection, _1: profile.connections}
										})
								})
						}),
					_1: _elm_lang$core$Platform_Cmd$none
...
var _user$project$Home$onAddLink = F2(
	function (subMsg, model) {
		var contributor = model.contributor;
		var link = A2(
			_user$project$Controls_AddLink$update,
			subMsg,
			_elm_lang$core$Tuple$first(contributor.newLink));
		var _p13 = subMsg;
		switch (_p13.ctor) {
			case 'InputTitle':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							contributor: _elm_lang$core$Native_Utils.update(
								contributor,
								{
									newLink: {ctor: '_Tuple2', _0: link, _1: false}
								})
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							contributor: _elm_lang$core$Native_Utils.update(
								contributor,
								{
									newLink: {ctor: '_Tuple2', _0: link, _1: true}
								})
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
...
var _user$project$Home$update = F2(
	function (msg, model) {
		...
		switch (_p14.ctor) {
			...
			case 'ToggleAll':
				return A2(_user$project$Home$toggleAllFilter, model, _p14._0);
			case 'ProfileThumbnail':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'NewConnection':
				return A2(_user$project$Home$onNewConnection, _p14._0, model);
			case 'Remove':
				return A2(_user$project$Home$onRemove, model, _p14._0);
			default:
				return A2(_user$project$Home$onAddLink, _p14._0, model);
		}
	});
var _user$project$Home$init = function (location) {
	var contributor = function () {
		...
		if ((((_p15.ctor === '::') && (_p15._0 === 'contributor')) && (_p15._1.ctor === '::')) && (_p15._1._1.ctor === '[]')) {
			var _p16 = _user$project$Settings$runtime.contributor(
				_user$project$Domain_Core$Id(_p15._1._0));
			if (_p16.ctor === 'Just') {
				return _user$project$Domain_Contributor$getContributor(_p16._0);
			} else {
...
var _user$project$Home$contributorPage = function (model) {
				...
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						...
						_1: {
							...
							_0: _elm_lang$html$Html_Events$onCheck(
								function (b) {
									return _user$project$Home$ToggleAll(b);
								}),
							_1: {ctor: '[]'}
						}
					}
	...
	var _p17 = {ctor: '_Tuple2', _0: model.profile.id, _1: model.profile.topics};
	var profileId = _p17._0;
	var topics = _p17._1;
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
																		...
																		_0: A2(
																			...
																			{ctor: '[]'},
																			{
																				...
																				_0: A2(
																					_elm_lang$html$Html$div,
																					{ctor: '[]'},
																					A3(_user$project$Home$contentUI, profileId, _user$project$Domain_Core$Answer, model.answers)),
																				_1: {ctor: '[]'}
																			}),
																		_1: {
																			ctor: '::',
...
var _user$project$Home$toCheckbox = function (topic) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$Home$contributorContentTypePage = F2(
	function (contentTypeText, model) {
		var posts = function () {
			var _p18 = _user$project$Domain_Core$toContentType(contentTypeText);
			switch (_p18.ctor) {
				case 'Answer':
		...
		var topics = model.profile.topics;
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], 'All ', contentTypeText)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
...
var _user$project$Home$dashboardPage = function (model) {
	...
	var _p19 = contributor.newLink;
	var link = _p19._0;
	var canAdd = _p19._1;
	var linkIfExists = canAdd ? A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$href(
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(
							_elm_lang$core$Basics_ops['++'],
							'Welcome ',
							_user$project$Domain_Core$getName(model.contributor.profile.name))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							_user$project$Controls_AddLink$view(link)),
						_1: {
							ctor: '::',
							_0: linkIfExists,
							_1: {ctor: '[]'}
...
var _user$project$Home$view = function (model) {
	var _p21 = _user$project$Home$tokenizeUrl(model.currentRoute.hash);
	_v13_7:
	do {
		if (_p21.ctor === '[]') {
					...
					if (_p21._0 === 'contributor') {
						if (_p21._1._1._1.ctor === '[]') {
							...
							if (_p21._1._1._1._1.ctor === '[]') {
								if (_p21._1._1._0 === 'all') {
									var _p24 = _user$project$Settings$runtime.contributor(
										_user$project$Domain_Core$Id(_p21._1._0));
									if (_p24.ctor === 'Just') {
										return A2(_user$project$Home$contributorContentTypePage, _p21._1._1._1._0, model.contributor);
									} else {
										return _user$project$Home$notFoundPage;
									}
								} else {
								...
								if ((_p21._1._1._1._0 === 'all') && (_p21._1._1._1._1._1.ctor === '[]')) {
									var _p25 = _user$project$Settings$runtime.contributor(
										_user$project$Domain_Core$Id(_p21._1._0));
									if (_p25.ctor === 'Just') {
										return A3(
											_user$project$Home$contributorTopicContentTypePage,
											_user$project$Domain_Core$Topic(_p21._1._1._0),
											_user$project$Domain_Core$toContentType(_p21._1._1._1._1._0),
											model.contributor);
									} else {
										return _user$project$Home$notFoundPage;
									}
