...
var Elm = {};
Elm['Tests'] = Elm['Tests'] || {};
Elm['Tests']['TestAPI'] = Elm['Tests']['TestAPI'] || {};
if (typeof _user$project$Tests_TestAPI$main !== 'undefined') {
    _user$project$Tests_TestAPI$main(Elm['Tests']['TestAPI'], 'Tests.TestAPI', undefined);
}
